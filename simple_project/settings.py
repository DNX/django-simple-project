...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(PROJECT_PATH, 'db/simple-project.db'),   # Or path to database file if using sqlite3.
...
SECRET_KEY = '64vs7!*x90txu77&v!dopq@l$orr&v)uxa4u7ob)))1v&d9s1v'
